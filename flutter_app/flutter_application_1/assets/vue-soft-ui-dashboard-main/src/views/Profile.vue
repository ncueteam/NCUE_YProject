          ...
          <div class="p-3 card-body">
            <ul class="list-group">
              ...
              >
                ...
                >
                  <h5 class="mb-0">電燈</h5>
                  <p class="mb-0 text-xs">2023/2/10 19:20 John 關閉...</p>
                </div>
                <soft-switch
              ...
              >
                ...
                >
                  <h5 class="mb-0">電燈</h5>
                  <p class="mb-0 text-xs">2/10 19:20 關閉</p>
                </div>
                <soft-switch
                  id="flexSwitchCheckDefault4"
                  name="Product Update"
      ...
      <div class="mt-4 col-12 col-md-6 col-xl-4 mt-md-0">
        <div class="card h-100">
          ...
          <div class="p-3 card-body">
            ...
            <li class="px-0 border-0 d-flex align-items-center">
              <div
                class="d-flex align-items-start flex-column justify-content-center"
              >
                <h5 class="mb-0">冷氣</h5>
            ...
            <collapse-transition>
                ...
                <li class="px-auto border-auto d-flex align-items-center">
                  <soft-radio id="flexS4" name="Produc" checked
                    >冷氣
                  </soft-radio>
                  <soft-radio id="flexS4" name="Produc">暖氣 </soft-radio>
                  <soft-radio id="flexS4" name="Produc">自動 </soft-radio>
                </li>
              
            </collapse-transition>
            <!-- <li class="px-0 border-0 d-flex align-items-center">
              <label for="appt">定時關</label>
              <input type="time" id="appt" name="appt" required />
            </li> -->
            <li class="px-0 border-0 d-flex align-items-center"></li>
            <li class="px-0 border-0 d-flex align-items-center">
              <div
                class="d-flex align-items-start flex-column justify-content-center"
              >
                <h5 class="mb-0">定時開</h5>
                <p class="mb-0 text-xs"></p>
              </div>
              <soft-switch
                @click="isOpen = !isOpen"
          ...
          <div class="p-3 card-body">
            <ul class="list-group">
              ...
              >
                <door-bell-card
                  title="前門門鈴"
                  value="2023/02/02 15:32 響過...."
                  :icon="{
                    component: 'fa fa-bell',
                    background: iconBackground,
                  }"
                />
              </li>
...
import DoorBellCard from "@/examples/Cards/DoorBellCard.vue";
...
export default {
  ...
  data() {
    return {
      ...
      isOpen2: false, // closed by default
      isOpen3: false, // closed by default
    };
  },
