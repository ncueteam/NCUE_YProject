...
from lib.device.ir_rx.print_error import print_error  # Optional print of error codes

# Import all implemented classes
from lib.device.ir_rx.nec import NEC_8, NEC_16, SAMSUNG
from lib.device.ir_rx.sony import SONY_12, SONY_15, SONY_20
from lib.device.ir_rx.philips import RC5_IR, RC6_M0
from lib.device.ir_rx.mce import MCE
